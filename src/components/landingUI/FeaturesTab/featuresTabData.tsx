...
const featuresTabData: FeatureTab[] = [
  {
    ...
    desc1: `User-friendly interface facilitating easy navigation and understanding, requiring minimal training.`,
    desc2: `Context-sensitive help features providing relevant assistance at the point of need, reducing reliance on external resources.`,
